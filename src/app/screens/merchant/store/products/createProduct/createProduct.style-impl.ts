...
interface CreateProductScreenStyle {
  rootView: ViewStyle;
  header: ViewStyle;
  logo: ImageStyle;
  ...
  createProductLogoStyle: ImageStyle;
  createProductLogoSubTextStyle: TextStyle;
...
export const styles = StyleSheet.create<CreateProductScreenStyle>({
  ...
  createProductLogoStyle: {
    marginLeft: 20,
    marginRight: 20,
  },
  createProductLogoSubTextStyle: {
    marginLeft: 50,
    marginRight: 20,
  },
